...
export class TestRequestPeopleListComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.http.get<PeopleList[]>("https://monhes.github.io/PeopleListAPI/PeopleList.json").subscribe(response => {console.log('response',response);this.PeopleList = response})
